...
gulp.task('browsersync-server', (done) => {
  browserSync({
    server: {
        baseDir: '_site'
    }
 ...
 */
gulp.task('js-develop', function (done) {
 ...
 */
gulp.task('jekyll-rebuild', gulp.series(['jekyll-develop', 'browsersync-reload']));

/**
 * Wait for jekyll-build, then launch the Server
 */
gulp.task('browser-sync', gulp.series(['sass-develop', 'js-develop', 'jekyll-develop', 'browsersync-server']));
 ...
 */
gulp.task('build', gulp.series(['jekyll-build', 'sass-build', 'js-build']));
